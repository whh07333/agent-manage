...
test.describe('Debug project creation after fix', () => {
  test.use({
    storageState: {
      origins: [
        {
  ...
  test('debug create project after managerId fix', async ({ page }) => {
    ...
    console.log('Modal visible after create:', modalVisible);
